...
@st.cache_resource
def load_model():
    model = keras.models.load_model('/root/Workspace/CapSton_Project/Final_Capstone_Project_Anwar_Aziz_Hesham/Attendees_management_system/Attendees_management_system/finetuning_model_classifction.keras', custom_objects={"RandomColorAffine": RandomColorAffine})
...
@st.cache_resource
def load_yolo_model():
    return YOLO('/root/Workspace/CapSton_Project/Final_Capstone_Project_Anwar_Aziz_Hesham/Attendees_management_system/Attendees_management_system/best.pt')
